...
RULES = [
    (
        ...
        lambda p: (
            "ปรับลดความเร็วให้เหมาะสม และใช้ความระมัดระวังเป็นพิเศษ"
            if p["level"] == "high"
            else "ปรับลดความเร็วให้เหมาะสม และใช้ความระมัดระวัง"
        ),
    ),
    (
        "junction",
...
def build_alert_message(point, distance_m):
    ...
    if point["level"] == "high":
        advice = top["advice"] if top else "ปรับลดความเร็วให้เหมาะสม และใช้ความระมัดระวังเป็นพิเศษ"
