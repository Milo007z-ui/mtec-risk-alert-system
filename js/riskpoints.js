...
const RiskPoints = (() => {
  ...
  /**
   * วาดเฉพาะ "คลัสเตอร์" (171 วง) เป็นหมุดขนาดคงที่ตามดีไซน์เดิม
   *
   ...
   *
   * หน่วยวิเคราะห์ชนิด noise (จุดเสี่ยงเดี่ยว 676 จุด) ไม่วาดที่ชั้นนี้
   * เพราะชั้นจุดเสี่ยง (accidents.js) ปิดอยู่ — แต่ยังอยู่ใน `points`
   * เพื่อให้ระบบแจ้งเตือนตรวจครบทั้ง 847 หน่วย
   */
