 ...
 *
 * กติกาทิศทาง: เตือนเฉพาะจุดที่อยู่ในมุม +-90 องศาจากทิศที่รถกำลังมุ่งหน้าไป
 * จุดที่ขับผ่านมาแล้วจะเงียบ เพราะเตือนไปก็ไม่มีประโยชน์ รบกวนคนขับเปล่า ๆ
 * ข้อจำกัด: แยกได้แค่ข้างหน้า/ข้างหลัง ไม่ได้แยกเลนขาขึ้น-ขาล่อง — เลนสวนที่อยู่
 * ข้างหน้า 100 ม. เบนจากทิศรถแค่ 8.5 องศา น้อยกว่าความคลาดเคลื่อนของ GPS เอง
 * ปิดการกรองด้วย ?heading=180 ถ้าอยากได้พฤติกรรมก่อนมีฟีเจอร์นี้
 */
...
const AlertSystem = (() => {
  ...
  //
  // ปรับสดหน้างานได้ด้วย ?heading=<องศา> บน URL · 180 = ปิดการกรอง เตือนทุกทิศ
  // ** ต้องตั้งให้ตรงกับ DEFAULT_HEADING_WINDOW_DEG ใน device/pi_alert_client.py **
