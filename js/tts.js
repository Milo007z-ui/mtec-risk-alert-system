...
const TTS = (() => {
  ...
  const VOICE_CLIPS = {
    // ⚠️ รอบนี้เติม "จุดเสี่ยงระดับ ต่ำ/ปานกลาง/สูง" เข้าไปตามที่ผู้ใช้ขอ (เดิมไม่พูด
    // ชื่อระดับตรง ๆ) ข้อความเปลี่ยนหมดทั้ง 12 ไฟล์ ต้องอัดใหม่ทุกไฟล์ ไม่ใช่แค่ที่ยังไม่ทำ
    //  1. low    (319 วง)
    "ข้างหน้าอีกประมาณ 500 เมตร จุดเสี่ยงระดับต่ำ ขอให้ขับขี่ด้วยความระมัดระวัง":
      "alert_01.mp3",
    //  2. medium (51 วง)
    "ข้างหน้าอีกประมาณ 500 เมตร จุดเสี่ยงระดับปานกลาง กรุณาลดความเร็ว และใช้ความระมัดระวัง":
      "alert_02.mp3",
    //  3. medium (27 วง)
    "ข้างหน้าอีกประมาณ 500 เมตร จุดเสี่ยงระดับปานกลาง กรุณาลดความเร็ว และประคองพวงมาลัยให้มั่นคง":
      "alert_03.mp3",
    //  4. medium (24 วง)
    "ข้างหน้าอีกประมาณ 500 เมตร จุดเสี่ยงระดับปานกลาง กรุณาเว้นระยะห่างจากคันหน้า และระวังรถเปลี่ยนช่องทาง":
      "alert_04.mp3",
    //  5. high   (9 วง)
    "ข้างหน้าอีกประมาณ 500 เมตร จุดเสี่ยงระดับสูง กรุณาลดความเร็ว และใช้ความระมัดระวังเป็นพิเศษ":
      "alert_05.mp3",
    //  6. high   (8 วง)
    "ข้างหน้าอีกประมาณ 500 เมตร จุดเสี่ยงระดับสูง กรุณาเว้นระยะห่างจากคันหน้า และระวังรถเปลี่ยนช่องทาง":
      "alert_06.mp3",
    //  7. medium (5 วง)
    "ข้างหน้าอีกประมาณ 500 เมตร จุดเสี่ยงระดับปานกลาง กรุณาชะลอความเร็ว และระวังรถตัดผ่านทางแยก":
      "alert_07.mp3",
    //  8. high   (5 วง)
    "ข้างหน้าอีกประมาณ 500 เมตร จุดเสี่ยงระดับสูง กรุณาลดความเร็ว และประคองพวงมาลัยให้มั่นคง":
      "alert_08.mp3",
    //  9. medium (4 วง)
    "ข้างหน้าอีกประมาณ 500 เมตร จุดเสี่ยงระดับปานกลาง กรุณาใช้ความเร็วไม่เกิน 90 กิโลเมตรต่อชั่วโมง":
      "alert_09.mp3",
    // 10. high   (2 วง)
    "ข้างหน้าอีกประมาณ 500 เมตร จุดเสี่ยงระดับสูง กรุณาลดความเร็วก่อนเข้าโค้ง และงดแซงในช่วงนี้":
      "alert_10.mp3",
    // 11. medium (1 วง)
    "ข้างหน้าอีกประมาณ 500 เมตร จุดเสี่ยงระดับปานกลาง กรุณาลดความเร็วก่อนเข้าโค้ง และงดแซงในช่วงนี้":
      "alert_11.mp3",
    // 12. medium (1 วง)
    "ข้างหน้าอีกประมาณ 500 เมตร จุดเสี่ยงระดับปานกลาง กรุณาเว้นระยะห่าง และระวังรถชะลอตัวเพื่อกลับรถ":
      "alert_12.mp3"
  };
