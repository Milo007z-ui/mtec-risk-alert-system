...
const TTS = (() => {
  ...
  const VOICE_CLIPS = {
    // ⚠️ รอบสอง (2026-08-25): ตัด "ประมาณ" ออก เปลี่ยน "จุดเสี่ยงระดับ X" -> "ใกล้จุดเสี่ยง X"
    // และ "กรุณา/ขอให้" -> "โปรด" ทั้งสามระดับ ผู้ใช้เสนอเองแล้วอัดเสียงทดสอบที่ Botnoi
    // 300% ไปแล้ว (วัดจริง peak=1.000 rms=0.159 ก่อนแก้โค้ดรอบนี้)
    //  1. low    (319 วง)
    ...
    "ข้างหน้าอีก 500 เมตร ใกล้จุดเสี่ยงปานกลาง โปรดลดความเร็ว และใช้ความระมัดระวัง":
      "alert_02.mp3",
    //  3. medium (27 วง)
    "ข้างหน้าอีก 500 เมตร ใกล้จุดเสี่ยงปานกลาง โปรดลดความเร็ว และประคองพวงมาลัยให้มั่นคง":
      "alert_03.mp3",
    //  4. medium (24 วง)
    ...
    "ข้างหน้าอีก 500 เมตร ใกล้จุดเสี่ยงปานกลาง โปรดชะลอความเร็ว และระวังรถตัดผ่านทางแยก":
      "alert_07.mp3",
    //  8. high   (5 วง)
    "ข้างหน้าอีก 500 เมตร ใกล้จุดเสี่ยงสูง โปรดลดความเร็ว และประคองพวงมาลัยให้มั่นคง":
      "alert_08.mp3",
    //  9. medium (4 วง)
