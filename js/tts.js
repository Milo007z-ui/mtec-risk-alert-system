...
const TTS = (() => {
  ...
  const VOICE_CLIPS = {
    // ⚠️ รอบสาม (2026-08-25): fatal-history/single-vehicle/rollover ตัด "ลดความเร็ว"
    // ออก ใช้ "เพิ่มสมาธิในการขับขี่" แทน แล้วรวมเป็นประโยคเดียวกันทั้งสามกติกา
    // (ผู้ใช้ขอหลังหาคำแทน "ประคองพวงมาลัยให้มั่นคง" ไม่ลงตัวหลายรอบ) — เลข alert_03
    // และ alert_08 เดิมเลยว่างไป ไม่ต้องอัดไฟล์เพิ่ม ใช้ alert_02.mp3/alert_05.mp3
    // ร่วมกันแทน ไม่ได้ไล่เลขใหม่เพราะ alert_01 อัดไปแล้วก่อนหน้านี้
    //  1. low    (319 วง)
    ...
    "ข้างหน้าอีก 500 เมตร ใกล้จุดเสี่ยงปานกลาง โปรดเพิ่มสมาธิในการขับขี่ และใช้ความระมัดระวัง":
      "alert_02.mp3",
    //  4. medium (24 วง)
    ...
    "ข้างหน้าอีก 500 เมตร ใกล้จุดเสี่ยงสูง โปรดเพิ่มสมาธิในการขับขี่ และใช้ความระมัดระวังเป็นพิเศษ":
      "alert_05.mp3",
    //  6. high   (8 วง)
