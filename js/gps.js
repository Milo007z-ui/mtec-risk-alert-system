...
const GPS = (() => {
  ...
  // (id ตามรอบ calibration v2568-r1 — เรียงตามลำดับบนถนนบางปะอิน-แขวงรามอินทรา ครบ 3 ระดับ)
  const MOCK_ROUTE_IDS = ["zone_159", "zone_200", "zone_169", "zone_188", "zone_161", "zone_182"];

  // จุดเสี่ยงที่ "ยกเว้นเฉพาะโหมดจำลอง" — ใส่ id จุดที่อยู่คนละฝั่งเลน/แรมป์ ที่รถไม่ได้ขับผ่านจริง
  // (รอบ v2568-r1 ยังไม่พบจุดที่ต้องยกเว้น)
