...
| เกณฑ์ลักษณะถนน | ยืมสัดส่วน conflict point ต่างประเทศ | **% เหตุที่เกิดบริเวณจุดตัดกระแสจราจร** (ตั้งแต่ r5) | อ่านเข้าใจทันที ("30% ของเหตุเกิดที่ทางแยก/ทางโค้ง") แทน gc_score ทศนิยม 1.0151 ที่อธิบายยาก |
...
## เกณฑ์ที่ 4: สัดส่วนเหตุที่จุดตัดกระแสจราจร (25%)

จัดกลุ่มจากคอลัมน์ `บริเวณที่เกิดเหตุ`:

| ค่าในคอลัมน์ | กลุ่ม conflict | นับเป็น "จุดตัดกระแส"? |
|---|---|---|
...
```
conflict_pct(จุด) = เหตุที่เกิดบริเวณจุดตัดกระแส / เหตุทั้งหมดของจุด × 100
...
จุดตัดกระแสมาก ยิ่งสะท้อนว่าเป็นปัญหาเชิงเรขาคณิตของถนน ไม่ใช่เหตุสุ่มบนทางตรง
...
ว่า "จุดตัดกระแส = อันตรายกว่าทางตรงจริงในบริบทไทย" (FI = เหตุที่มีผู้บาดเจ็บ/เสียชีวิต ≥ 1 ราย):
